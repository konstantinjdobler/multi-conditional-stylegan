...
class MappingNetwork(torch.nn.Module):
    ...
    def forward(self, z, c, truncation_psi=1, truncation_cutoff=None, skip_w_avg_update=False, conditional_truncation=False):
        ...
        if truncation_psi != 1:
            with torch.autograd.profiler.record_function('truncate'):
                ...
                if self.num_ws is None or truncation_cutoff is None:
                    ...
                    x[:, :truncation_cutoff] = w_center_of_mass.lerp(
...
class Generator(torch.nn.Module):
    ...
    def forward(self, z, c, truncation_psi=1, truncation_cutoff=None, conditional_truncation=False, **synthesis_kwargs):
        ws = self.mapping(z, c, truncation_psi=truncation_psi,
                          truncation_cutoff=truncation_cutoff, conditional_truncation=conditional_truncation)
